$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            // Event title
            title: "Nuntă Bianca și Eugen",

            // Event start date
            start: new Date('Jul 08, 2023 13:00'),
            ...
            end: new Date('Jul 09, 2023 00:30'),

            // Event Address
            address: 'Str. 7 Izvoare, Nr. 44, Mun. Sacele, Jud. Brasov, 505600',

            // Event Description
            description: "Vă așteptăm cu drag să petrecem împreună!."
        }
    });
...
// Google map
function initMap() {
    var location = {lat: 45.6034011, lng: 25.677267};
...
function initBBSRMap() {
    var la_fiesta = {lat: 45.6034011, lng: 25.677267};
    var map = new google.maps.Map(document.getElementById('map-canvas'), {
        zoom: 15,
        center: la_fiesta,
        scrollwheel: false
